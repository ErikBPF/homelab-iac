...
and delete one `adguard_config` resource against a disposable local AdGuard
...
Provider `gmichels/adguard` 1.7.0 passes the complete disposable lifecycle when
