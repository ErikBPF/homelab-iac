...
expected = {
    "agent-evals", "agentmemory", "ai-server", "aster", "buzz-flake", "codex-flake", "datafoundation-support-scripts",
    "cognee-homelab", "cosmo-notes", "deepseek-harness-flake", "desktop-nixos", "ha-harness", "hermes-flake",
...
text = pathlib.Path(sys.argv[1]).read_text()
assert 'generate "imports"' not in text
