...
@test "Galaxy S25 can SSH only to Gemini, Endeavour, and Orion" {
  ...
  grep -qF '{"action": "accept", "src": ["galaxy-s25"], "dst": ["gemini:2222", "endeavour:2222", "orion:2222"]}' "$policy"
  grep -qF '{"src": "galaxy-s25", "accept": ["gemini:2222", "endeavour:2222", "orion:2222"]}' "$policy"
