...
- [`docs/2026-09-07-paused-ha-route.md`](docs/2026-09-07-paused-ha-route.md) — withdraw the paused household HA route while preserving credentials and checks for promised services.
